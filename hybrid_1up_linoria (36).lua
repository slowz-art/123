        ...
        Library.Pages.Section = function(self, Data)
            ...
            function Section:ToggleBackground()
                ...
                if not Section.IsActive then
                    -- Hide all groupbox content (only header + toggle stay)
                    ...
                    -- Collapse frame to header height only
                    Items["Section"].Instance.AutomaticSize = Enum.AutomaticSize.None
                    Items["Section"]:Tween(nil, {Size = UDim2New(1, 0, 0, 55)})
                else
                    -- Show content again
                    ...
                    -- Restore auto-height so content fits
